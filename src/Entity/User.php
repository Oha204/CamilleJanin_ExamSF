...
#[UniqueEntity('email','This username already exist')]
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToOne]
    private ?ActivityArea $activity = null;

    #[ORM\ManyToOne]
    private ?ContractType $contractType = null;

    #[ORM\Column]
    private ?bool $contractStatus = null;
    ...
    public function getActivity(): ?ActivityArea
    {
        return $this->activity;
    }

    public function setActivity(?ActivityArea $activity): static
    {
